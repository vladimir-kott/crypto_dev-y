  ...
  return (
    <div className="App max-h-screen">
      <div className='flex flex-col h-screen bg-gradient-to-tr from-[#EAECF4] to-[#E6E7FD] border-2 border-black'>
        <div className="box-border flex sam:flex-col sus:flex-col scm:flex-col sxm:flex-col sm:flex-row justify-center items-center gap-x-[15px] w-full border-2 border-black h-full">
