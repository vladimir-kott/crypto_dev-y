    ...
    return ( 
        <form className="h-full flex flex-col justify-center items-center max-w-sm 
            ...
            <div className="mb-6 w-full">
                ...
                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-zinc-500 leading-tight focus:outline-none focus:shadow-outline" 
                    id="email"
                    name="email" 
                    type="text"
                    value={data.name} 
            ...
            <div className="mb-6 w-full">
                <label className="block float-left pl-2 text-zinc-500 text-sm font-bold mb-2" htmlFor="password">
                    Password
                </label>
                <input className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-zinc-500 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                id="password"
                name="password"
                type="password" 
                value={data.password}
